...
@Document(collection="InstitucionesRespaldo")
public class InstitucionRespaldo {
    ...
    public InstitucionRespaldo(int idN, String nombreN, String direccionN, long telefonoN, int proovedorCobranzaN, int gestorContableN, int jefeAdministrativoN, int gestorFinancieroN) {
